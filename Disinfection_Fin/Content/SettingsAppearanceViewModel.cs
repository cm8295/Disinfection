...
namespace Disinfection_Fin.Content
{
    /// <summary>
        ...
        : NotifyPropertyChanged
    {
        ...
        public SettingsAppearanceViewModel()
        {
            ...
            this.themes.Add(new Link { DisplayName = "snowflakes", Source = new Uri("Content/ModernUI.Snowflakes.xaml", UriKind.Relative) });
        ...
        private void OnAppearanceManagerPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == "ThemeSource" || e.PropertyName == "AccentColor")
            {
                if (e.PropertyName == "AccentColor")
                {
                    ...
                    xn1.Attributes["index"].Value = AppearanceManager.Current.AccentColor.R.ToString() + "," + AppearanceManager.Current.AccentColor.G + "," + AppearanceManager.Current.AccentColor.B;
                    xd.Save("config.xml");
                }
                SyncThemeAndColor();
            }
